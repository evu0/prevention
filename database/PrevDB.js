...
// BRCA-Related Cancer?? https://www.uspreventiveservicestaskforce.org/webview/#!/topic/413
    {
        id: 1,
        title: 'قياس ضغط الدم',
        importance: 'يعتبر إرتفاع ضغط الدم حالة شائعة تكون فيها قوة اندفاع الدم مرتفعة وطويلة الأمد مقابل جدران الشرايين بما يكفي للتسبب بمشكلات صحية؛ ومن الشائع إيضًا عدم ظهور أعراض لإرتفاع ضغط الدم ولذلك يسمى بـ" القاتل الصامت ". ',
        conditions: [
            {
                condition: 1,
    ...
    },
    {
        ...
        importance: 'قد يؤدي تجرثم البول عند الحوامل إلى التهاب الكلى، والذي بدوره قد يتسبب في تدهور صحة الأم والجنين.',
        conditions: [
            {
                condition: 1,
    ...
    },
    {
        ...
        importance: 'المتدثرة الحثرية والسيلان من أكثر العدوات المنقولة جنسيًا، قد يساعد الفحص المبكر في تجنب المضاعفات وزيادة فعالية العلاج.',
        conditions: [
            {
                condition: 1,
    ...
    },
    {
        id: 8,
        title: 'فحص الاكتئاب',
        importance: 'يعد الاكتئاب من أكثر الأسباب المرتبطة بانخفاض جودة الحياة',
        conditions: [
            {
                condition: 1,
                frequency: 'لا توجد معلومات دقيقة',
    ...
    },
    {
        id: 9,
        title: 'فحص سكر الحمل',
        importance: 'العلاج المبكر لسكر الحمل يحسن من صحة الأم والجنين ويقي من مضاعفاته.',
        conditions: [
            {
                condition: 1,
    ...
    },
    {
        ...
        importance: 'يؤثر تسوس الأسنان في الطفولة سلبًا على جودة الحياة، وينطوي ذلك على عدة أمور، كتدني الأداء الدراسي، وضعف النمو، وزيادة احتمالية تسوس الأسنان مستقبلًا.',
        conditions: [
            {
                condition: 1,
                frequency: 'لا يوجد معلومات',
