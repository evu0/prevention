...
// BRCA-Related Cancer?? https://www.uspreventiveservicestaskforce.org/webview/#!/topic/413
    ...
    },
    {
        ...
        importance: 'يؤثر تسوس الأسنان في الطفولة سلبًا على جدوة الحياة، وينطوي ذلك على عدة أمور، كتدني الأداء الدراسي، وضعف النمي، وزيادة إحتمالية تسوس الأسنان مستقبلًا.',
        conditions: [
            {
                condition: 1,
                frequency: 'لا يوجد معلومات',
